(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[86],{"2/9e":function(e,a,t){"use strict"
var n=t("An8g")
t("q1tI")
var r=t("i8i4")
var i=t.n(r)
...
function b(e,a,t){if(!INST.kalturaSettings)return console.log("Kaltura has not been enabled for this account")
let n,r
const o=s()(e)
try{const e=document.createElement("a")
e.href=o.attr("href")
r=e}catch(e){}if(r&&Object(d["a"])(r.search).no_preview)return
const m=_[a]||_.normal
const l=o.data("media_comment_id")||s.a.trim(o.find(".media_comment_id:first").text())||(n=o.attr("id"))&&n.match(/^media_comment_/)&&n.substring(14)||s.a.trim(o.parent().find(".media_comment_id:first").text())
const b=o.data("author")
const u=o.data("created_at")
let p
p=b&&u?i.t("Play media comment by %{name} from %{createdAt}.",{name:b,createdAt:u}):i.t("Play media comment.")
if(l){const e="https://".concat(INST.kalturaSettings.resource_domain)
const n="".concat(e,"/p/").concat(INST.kalturaSettings.partner_id,"/thumbnail/entry_id/").concat(l,"/width/")+"".concat(m.width,"/height/").concat(m.height,"/bgcolor/000000/type/2/vid_sec/5")
const r=s()("<span\n        style='background-image: url(".concat(Object(c["a"])(n),");'\n        class='media_comment_thumbnail media_comment_thumbnail-").concat(Object(c["a"])(a),"'\n      >\n        <span class='media_comment_thumbnail_play_button'>\n          <span class='screenreader-only'>\n            ").concat(Object(c["a"])(p),"\n          </span>\n        </span>\n      </span>"))
const i=o.closest("p")
i.attr("title")||i.attr("title",Object(c["a"])(p))
let d=o
if(t){d=o.clone().empty().removeClass("instructure_file_link")
const e=o.parent(".instructure_file_link_holder")
e.length?d.appendTo(e):o.after(d)}else o.empty()
d.data("download",d.attr("href")).prop("href","#").addClass("instructure_inline_media_comment").append(r).css({backgroundImage:"",padding:0})}}s.a.fn.mediaCommentThumbnail=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"normal"
let a=arguments.length>1?arguments[1]:void 0
return this.each((function(){m.a.defer(b,this,e,a)}))}},"8o96":function(e,a,t){"use strict"
t.d(a,"a",(function(){return o}))
var n=t("QF4Q")
var r=t("gCYW")
var i=t("ISHz")
function o(e,a){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:["width"]
var o=Object(n["a"])(e)
var m=Object(r["a"])(o)
var c=false
var l
var s=function e(){if(c)return
var n=Object(r["a"])(o)
var s={width:n.width,height:n.height}
t.some((function(e){return s[e]!=m[e]}))&&"function"===typeof a&&a(s)
m=s
l=Object(i["a"])(e)}
s()
return{remove:function(){c=true
l.cancel()}}}},O7M4:function(e,a,t){"use strict"
var n=t("rePB")
var r=t("1OyB")
var i=t("vuIU")
var o=t("md7G")
...
var f=t("jtGx")
var h=t("n12J")
function g(e){var a=e.colors
return{debugOutlineColor:a.borderSuccess}}t.d(a,"a",(function(){return w}))
var y,v,x,O
var j={componentId:"dHGMZ",template:function(e){return"\n\n.dHGMZ_bGBk{box-sizing:border-box;flex-shrink:0;min-width:0.0625rem}\n\n.dHGMZ_ffgL{align-self:flex-start}\n\n.dHGMZ_fjOx{align-self:flex-end}\n\n.dHGMZ_bJAR{align-self:center}\n\n.dHGMZ_eFer{align-self:stretch}\n\n.dHGMZ_SpYf{flex-grow:1}\n\n.dHGMZ_buwJ{flex-shrink:1}\n\n.dHGMZ_fFVr{outline:0.0625rem dashed ".concat(e.debugOutlineColor||"inherit","}")},root:"dHGMZ_bGBk","align--start":"dHGMZ_ffgL","align--end":"dHGMZ_fjOx","align--center":"dHGMZ_bJAR","align--stretch":"dHGMZ_eFer",grow:"dHGMZ_SpYf",shrink:"dHGMZ_buwJ",visualDebug:"dHGMZ_fFVr"}
var w=(y=Object(p["i"])(g,j),y(v=(O=x=function(e){Object(c["a"])(a,e)
function a(){Object(r["a"])(this,a)
return Object(o["a"])(this,Object(m["a"])(a).apply(this,arguments))}Object(i["a"])(a,[{key:"render",value:function(){var e
var t=Object(f["a"])(this.props,a.propTypes)
var r=this.props,i=r.align,o=r.as,m=r.elementRef,c=r.children,l=r.direction,d=r.grow,_=r.margin,b=r.overflowX,p=r.overflowY,g=r.padding,y=r.shrink,v=r.size,x=r.textAlign,O=r.visualDebug
var w="column"===l
var G={flexBasis:v}
var k=(e={},Object(n["a"])(e,j.root,true),Object(n["a"])(e,j.visualDebug,O),Object(n["a"])(e,j.grow,d),Object(n["a"])(e,j.shrink,y),Object(n["a"])(e,j["align--".concat(i)],i),e)
return s.a.createElement(h["a"],Object.assign({},t,{className:u()(k),style:G,elementRef:m,as:o,minHeight:w?v:void 0,minWidth:"row"===l?v:void 0,textAlign:x,margin:_,padding:g,overflowX:b,overflowY:p||(w?"auto":"visible"),__dangerouslyIgnoreExperimentalWarnings:true}),c)}}])
a.displayName="FlexItem"
return a}(l["Component"]),x.propTypes={align:_.a.oneOf(["center","start","end","stretch"]),as:_.a.elementType,elementRef:_.a.func,children:_.a.node,direction:_.a.oneOf(["row","column"]),grow:_.a.bool,shrink:_.a.bool,size:_.a.string,textAlign:_.a.oneOf(["start","center","end"]),margin:p["c"].spacing,padding:p["c"].spacing,visualDebug:_.a.bool,overflowX:_.a.oneOf(["auto","hidden","visible"]),overflowY:_.a.oneOf(["auto","hidden","visible"])},x.defaultProps={as:"span",elementRef:function(e){},grow:false,shrink:false},O))||v)},OShF:function(e,a,t){"use strict"
var n=t("ouhR")
var r=t.n(n)
var i=t("5Ky4")
t("JI1W")
r.a.fn.fillTemplateData=function(e){if(this.length&&e){e.iterator&&this.find("*").andSelf().each((function(){const a=r()(this)
r.a.each(["name","id","class"],(t,n)=>{a.attr(n)&&a.attr(n,a.attr(n).replace(/-iterator-/,e.iterator))})}))
e.id&&this.attr("id",e.id)
let n=false
if(e.data)for(var a in e.data){if(e.except&&-1!=r.a.inArray(a,e.except))continue
e.data[a]&&e.dataValues&&-1!=r.a.inArray(a,e.dataValues)&&this.data(a,e.data[a].toString())
const o=this.find("."+a)
var t=e.avoid||""
o.each((function(){const o=r()(this)
if(o.length>0&&0===o.closest(t).length){"undefined"!==typeof e.data[a]&&null!==e.data[a]||(e.data[a]="")
if(e.htmlValues&&-1!=r.a.inArray(a,e.htmlValues)){o.html(r.a.raw(e.data[a].toString()))
if(o.hasClass("user_content")){n=true
o.removeClass("enhanced")
o.data("unenhanced_content_html",e.data[a].toString())}}else if("INPUT"==o[0].tagName.toUpperCase())o.val(e.data[a])
else try{const t=e.data[a].toString()
o.html(Object(i["a"])(t))}catch(e){}}}))}e.hrefValues&&e.data&&this.find("a,span[rel]").each((function(){let a,t,n,i=r()(this)
for(const o in e.hrefValues){if(!e.hrefValues.hasOwnProperty(o))continue
const m=e.hrefValues[o]
if(a=i.attr("href")){const t=r.a.replaceTags(a,m,encodeURIComponent(e.data[m]))
const n=i.text()===i.html()?i.text():null
if(a!==t){i.attr("href",t)
n&&i.text(n)}}(t=i.attr("rel"))&&i.attr("rel",r.a.replaceTags(t,m,e.data[m]));(n=i.attr("name"))&&i.attr("name",r.a.replaceTags(n,m,e.data[m]))}}))
...
var a,t={}
if(e.textValues){const a=this
e.textValues.forEach(e=>{const i=a.find("."+e.replace(/\[/g,"\\[").replace(/\]/g,"\\]")+":first")
n=r.a.trim(i.text())
"&nbsp;"===i.html()&&(n="")
1===n.length&&160===n.charCodeAt(0)&&(n="")
t[e]=n})}if(e.dataValues)for(a in e.dataValues){var n=this.data(e.dataValues[a])
n&&(t[e.dataValues[a]]=n)}if(e.htmlValues)for(a in e.htmlValues){const i=this.find("."+e.htmlValues[a].replace(/\[/g,"\\[").replace(/\]/g,"\\]")+":first")
n=null
n=i.hasClass("user_content")&&i.data("unenhanced_content_html")?i.data("unenhanced_content_html"):r.a.trim(i.html())
t[e.htmlValues[a]]=n}return t}
r.a.fn.getTemplateValue=function(e,a){const t=r.a.extend({},a,{textValues:[e]})
return this.getTemplateData(t)[e]}},bwhI:function(e,a,t){"use strict"
var n=t("rePB")
var r=t("1OyB")
var i=t("vuIU")
var o=t("md7G")
...
var g=t("jtGx")
var y=t("oXx0")
function v(e){var a=e.borders,t=e.colors,n=e.spacing,r=e.typography
return{fontFamily:r.fontFamily,fontWeight:r.fontWeightNormal,padding:"0 ".concat(n.xSmall),height:"1.3125rem",background:t.backgroundLightest,lineHeight:r.lineHeightFit,textTransformStyle:"uppercase",textFontSize:r.fontSizeXSmall,textFontWeight:r.fontWeightBold,maxWidth:"15rem",color:t.textDark,primaryColor:t.textBrand,dangerColor:t.textDanger,successColor:t.textSuccess,warningColor:t.textWarning,messageColor:t.textAlert,borderWidth:a.widthSmall,borderStyle:a.style,borderRadius:"999rem",focusOutlineWidth:a.widthMedium,focusOutlineColor:t.borderBrand,focusOutlineStyle:a.style}}v["canvas-a11y"]=v["canvas-high-contrast"]=function(e){var a=e.colors
return{color:a.textDarkest,borderColor:a.borderDarkest}}
v.canvas=function(e){return{primaryColor:e["ic-brand-primary"]}}
var x=t("sIA8")
...
var M=(O=Object(y["a"])(),j=Object(h["i"])(v,C),O(w=j(w=(k=G=function(e){Object(c["a"])(a,e)
function a(e){var t
Object(r["a"])(this,a)
t=Object(o["a"])(this,Object(m["a"])(a).call(this,e))
t.state={truncated:false}
return t}Object(i["a"])(a,[{key:"handleTruncation",value:function(e){this.setState({truncated:e})}},{key:"renderPill",value:function(e,t){var r,i=this
var o=this.props,m=o.margin,c=o.text,l=o.variant,d=o.as,_=o.elementRef
var b=p["a"].omitViewProps(Object(g["a"])(this.props,a.propTypes),a)
var f="function"===typeof t?t(b):b
var h=u()((r={},Object(n["a"])(r,C.root,true),Object(n["a"])(r,C.truncated,this.state.truncated),Object(n["a"])(r,C.focused,e),Object(n["a"])(r,C[l],l),r))
return s.a.createElement(p["a"],Object.assign({},f,{className:h,as:d,elementRef:_,margin:m,display:"inline-flex",__dangerouslyIgnoreExperimentalWarnings:true}),s.a.createElement("span",{className:C.text},s.a.createElement(x["a"],{onUpdate:function(e){i.handleTruncation(e)}},c)))}},{key:"render",value:function(){var e=this
return this.state.truncated?s.a.createElement(f["a"],{tip:this.props.text},(function(a){var t=a.focused,n=a.getTriggerProps
return e.renderPill(t,n)})):this.renderPill()}}])
a.displayName="Pill"
return a}(l["Component"]),G.propTypes={text:_.a.node.isRequired,margin:h["c"].spacing,variant:_.a.oneOf(["default","success","danger","primary","warning","message"]),elementRef:_.a.func,as:_.a.elementType},G.defaultProps={margin:void 0,elementRef:void 0,variant:"default"},k))||w)||w)},cuKi:function(e,a,t){"use strict"
t.d(a,"a",(function(){return i}))
var n=t("GLiE")
var r=t.n(n)
function i(e){return r()(e).reduce((e,a,t)=>{let n=t.split("][")
let i=n.length-1
if(/\[/.test(n[0])&&/\]$/.test(n[i])){n[i]=n[i].replace(/\]$/,"")
n=n.shift().split("[").concat(n)
i=n.length-1}else i=0
if(i){let r=0
let o=e
while(r<=i){t=""===n[r]?o.length:n[r]
o=o[t]=r<i?o[t]||(n[r+1]&&isNaN(n[r+1])?{}:[]):a
r++}}else r.a.isArray(e[t])?e[t].push(a):null!=e[t]?e[t]=[e[t],a]:e[t]=a
return e},{})}},dKDz:function(e,a,t){"use strict"
var n=/["'&<>]/
e.exports=r
function r(e){var a=""+e
var t=n.exec(a)
if(!t)return a
var r
var i=""
var o=0
var m=0
for(o=t.index;o<a.length;o++){switch(a.charCodeAt(o)){case 34:r="&quot;"
break
case 38:r="&amp;"
break
case 39:r="&#39;"
...
case 62:r="&gt;"
break
default:continue}m!==o&&(i+=a.substring(m,o))
m=o+1
i+=r}return m!==o?i+a.substring(m,o):i}},hX7l:function(e,a,t){"use strict"
t.d(a,"a",(function(){return o}))
var n=t("ODXe")
var r=t("cuKi")
const i={true:true,false:false,null:null}
function o(e,a){if(!e||"boolean"===typeof e){const e=window.location.search
if(!e)return{}
return o(e,...arguments)}const t={}
e.replace(/\+/g," ").split("&").forEach(e=>{let r=e.split("="),o=Object(n["a"])(r,2),m=o[0],c=o[1]
m=decodeURIComponent(m)
c=decodeURIComponent(c)
a&&(c=c&&!isNaN(c)?+c:"undefined"===c?void 0:void 0!==i[c]?i[c]:c)
t[m]=c})
return Object(r["a"])(t)}},nhsw:function(e,a,t){"use strict"
var n=t("rePB")
var r=t("VTBJ")
var i=t("1OyB")
var o=t("vuIU")
...
var v=t("n12J")
var x=t("O7M4")
function O(e){var a=e.colors,t=e.typography
return{fontFamily:t.fontFamily,debugOutlineColor:a.borderDebug}}t.d(a,"a",(function(){return M}))
var j,w,G,k
...
var M=(j=Object(f["i"])(O,C),j(w=(k=G=function(e){Object(l["a"])(a,e)
function a(){Object(i["a"])(this,a)
return Object(m["a"])(this,Object(c["a"])(a).apply(this,arguments))}Object(o["a"])(a,[{key:"renderChildren",value:function(){var e=this
return s["Children"].map(this.props.children,(function(a){return a?Object(g["a"])(a,Object(r["a"])({visualDebug:e.props.visualDebug},a.props,{direction:e.props.direction.replace(/-reverse/,"")})):null}))}},{key:"render",value:function(){var e
var t=Object(y["a"])(this.props,a.propTypes)
var r=this.props,i=r.as,o=r.elementRef,m=r.children,c=r.direction,l=r.height,s=r.inline,_=r.margin,b=r.padding,u=r.justifyItems,f=r.textAlign,h=r.visualDebug,g=r.width,x=r.wrapItems
var O=this.props.alignItems||("column"===c||"column-reverse"===c?"stretch":"center")
var j=(e={},Object(n["a"])(e,C.root,true),Object(n["a"])(e,C.visualDebug,h),Object(n["a"])(e,C["justifyItems--".concat(u)],true),Object(n["a"])(e,C["alignItems--".concat(O)],true),Object(n["a"])(e,C.wrapItems,x),e)
return m&&d.a.Children.count(m)>0?d.a.createElement(v["a"],Object.assign({},t,{className:p()(j,C[c]),elementRef:o,as:i,display:s?"inline-flex":"flex",width:g,height:l,margin:_,padding:b,textAlign:f,__dangerouslyIgnoreExperimentalWarnings:true}),this.renderChildren()):null}}])
a.displayName="Flex"
return a}(s["Component"]),G.propTypes={children:h["a"].oneOf([x["a"]]),as:b.a.elementType,elementRef:b.a.func,direction:b.a.oneOf(["row","column","row-reverse","column-reverse"]),height:b.a.oneOfType([b.a.string,b.a.number]),width:b.a.oneOfType([b.a.string,b.a.number]),inline:b.a.bool,textAlign:b.a.oneOf(["start","center","end"]),margin:f["c"].spacing,padding:f["c"].spacing,alignItems:b.a.oneOf(["center","start","end","stretch"]),justifyItems:b.a.oneOf(["center","start","end","space-around","space-between"]),visualDebug:b.a.bool,wrapItems:b.a.bool},G.defaultProps={children:null,as:"span",elementRef:function(e){},direction:"row",justifyItems:"start",inline:false,visualDebug:false,wrapItems:false,width:void 0,height:void 0,padding:void 0,margin:void 0,alignItems:void 0,textAlign:void 0},G.Item=x["a"],k))||w)}}])

//# sourceMappingURL=86-c-e0bdda0c4d.js.map