(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[539,57,64,93,118,120],{"/J48":function(e,t,i){"use strict"
var n=i("rePB")
var r=i("1OyB")
var o=i("vuIU")
var a=i("md7G")
...
var h=(e={},Object(n["a"])(e,C.root,true),Object(n["a"])(e,C.disabled,o),Object(n["a"])(e,C[c],true),Object(n["a"])(e,C[l],"toggle"===c),Object(n["a"])(e,C[_],true),Object(n["a"])(e,C["inline"],u),e)
return d.a.createElement("div",{className:m()(h)},d.a.createElement("input",Object.assign({},f,{id:this.id,ref:function(e){i._input=e},value:p,name:g,checked:this.checked,type:"radio",className:C.input,disabled:o||a,"aria-disabled":o||a?"true":null,onChange:this.handleChange,onClick:this.handleClick})),d.a.createElement("label",{className:C.control,htmlFor:this.id},d.a.createElement("span",{className:C.facade,"aria-hidden":"true"}),d.a.createElement("span",{className:C.label},s)))}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"focused",get:function(){return Object(v["a"])(this._input)}},{key:"checked",get:function(){return"undefined"===typeof this.props.checked?this.state.checked:this.props.checked}}])
...
class C extends h{install(e){const t=navigator,i=t.userAgent
_.a.log("I've been loaded by ".concat(i,"."))
if(-1===location.href.indexOf("question")&&location.href.indexOf("take")>0)return e({user_agent:i})}}C.prototype.eventType=n.EVT_SESSION_STARTED
C.prototype.options={}
const x=[b,v,S,j,C]
const O=new f
x.forEach(e=>O.registerTracker(e))
...
i("SJWK")
i("MWZS")
class x extends f["a"]{static initClass(){this.prototype.tagName="ul"
...
return this.$el.find("[tabindex=0]:first").focus()})))}revertTitle(e){return e.set({title:e.previous("title"),description:e.previous("description")},{silent:true})}}i.d(t,"a",(function(){return M}))
let P
class M extends u.a.View{static initClass(){this.prototype.directoryWidth=200
...
const r=e.get("directoryClass")||x
...
return this}findDialog(e){if(P)P.updateSelection(this.selectedGroup())
else{P=new e({title:o.t("titles.find_outcomes","Find Outcomes"),selectedGroup:this.selectedGroup(),directoryView:new N({outcomeGroup:this.selectedGroup()})})
P.on("import",this.addAndSelect,this)}return P.show()}dirForGroup(e){return _.a.find(this.directories,t=>t.outcomeGroup===e)||this.addDirFor(e)}moveItem(e,t){let i
...
return this.directories[e].$el.animate({scrollTop:n},{duration:200})}_findLastDir(e){return _.a.find(_.a.clone(this.directories).reverse(),e)||_.a.last(this.directories)}}M.initClass()
...
var C=p["default"].scoped("cyoe_assignment_sidebar_breakdown_details")
var x=i("KIj7")
var O=i("S4Kx")
var E=i("CyXg")
var A=i("HsON")
...
var P=p["default"].scoped("cyoe_assignment_sidebar_student_ranges_view")
const M=u.a.shape,q=u.a.string
M({course_id:q.isRequired,trigger_assignment:q.isRequired})
...
R({range:G,student:G})
const F=u.a.shape,U=u.a.string,H=u.a.number
F({id:H.isRequired,name:U.isRequired,avatar_url:U})
...
var V=p["default"].scoped("cyoe_assignment_sidebar_student_range_itme")
...
return Object(r["a"])("div",{className:"crs-student-range__item"},void 0,Object(r["a"])("img",{src:e,className:"crs-student__avatar",onClick:this.selectStudent}),Object(r["a"])("button",{className:"crs-student__name crs-link-button",onClick:this.selectStudent,"aria-label":V.t("Select student %{name}",{name:this.props.student.user.name})},void 0,this.props.student.user.name),n&&Object(r["a"])("span",{className:i}))}}u.a.object,u.a.func
...
const Ce=ue({[ze.LOAD_STUDENT_DETAILS_START]:()=>true,[ze.LOAD_STUDENT_DETAILS_END]:()=>false},false)
const xe=ue({[ze.SET_ERRORS]:(e,t)=>[...Array.from(t.payload),...Array.from(e)]},[])
...
const Pe=ue({[ze.OPEN_SIDEBAR]:()=>true,[ze.CLOSE_SIDEBAR]:()=>false,[ze.SELECT_RANGE]:(e,t)=>null!==t.payload},false)
const Me=ue({[ze.SELECT_RANGE]:(e,t)=>{e.range=t.payload
...
var qe=Object(n["combineReducers"])({apiUrl:pe(),jwt:pe(),studentCache:Se,isInitialDataLoading:je,isStudentDetailsLoading:Ce,errors:xe,ranges:Oe,assignment:Ee,rule:Ae,enrolled:De,sidebarTrigger:Ne,showDetails:Pe,selectedPath:Me})
...
return n}function C(e){void 0===e.size&&(e.size=e.__iterate(O))
return e.size}function x(e,t){if("number"!==typeof t){var i=t>>>0
if(""+i!==t||4294967295===i)return NaN
t=i}return t<0?C(e)+t:t}function O(){return true}function E(e,t,i){return(0===e||void 0!==i&&e<=-i)&&(void 0===t||void 0!==i&&t>=i)}function A(e,t){return N(e,t,0)}function D(e,t){return N(e,t,t)}function N(e,t,i){return void 0===e?i:e<0?Math.max(0,t+e):void 0===t?e:Math.min(t,e)}var P=0
var M=1
var q=2
...
return n}function G(){return{value:void 0,done:true}}function F(e){return!!V(e)}function U(e){return e&&"function"===typeof e.next}function H(e){var t=V(e)
return t&&t.call(e)}function V(e){var t=e&&(B&&e[B]||e[T])
...
this.size=e.length}X.prototype.get=function(e,t){return this.has(e)?this._array[x(this,e)]:t}
...
ye.prototype.get=function(e,t){return this.has(e)?this._start+x(this,e)*this._step:t}
...
we.Indexed=Se
we.Set=je
var Ce="function"===typeof Math.imul&&-2===Math.imul(4294967295,2)?Math.imul:function(e,t){e|=0
t|=0
var i=65535&e
var n=65535&t
return i*n+((e>>>16)*n+i*(t>>>16)<<16>>>0)|0}
function xe(e){return e>>>1&1073741824|3221225471&e}function Oe(e){if(false===e||null===e||void 0===e)return 0
...
i^=e}return xe(i)}if("string"===t)return e.length>Le?Ee(e):Ae(e)
...
return xe(t)}function De(e){var t
if(qe){t=Be.get(e)
if(void 0!==t)return t}t=e[Ie]
if(void 0!==t)return t
if(!Pe){t=e.propertyIsEnumerable&&e.propertyIsEnumerable[Ie]
if(void 0!==t)return t
t=Me(e)
...
if(Pe)Object.defineProperty(e,Ie,{enumerable:false,configurable:false,writable:false,value:t})
...
var Pe=function(){try{Object.defineProperty({},"@",{})
return true}catch(e){return false}}()
function Me(e){if(e&&e.nodeType>0)switch(e.nodeType){case 1:return e.uniqueID
...
var Ge=0
var Fe={}
function Ue(e){ve(Infinity!==e,"Cannot perform this action with an infinite size.")}t(He,ze)
function He(e){return null===e||void 0===e?rt():Ve(e)&&!d(e)?e:rt().withMutations((function(t){var i=n(e)
Ue(i.size)
i.forEach((function(e,i){return t.set(i,e)}))}))}He.of=function(){var t=e.call(arguments,0)
return rt().withMutations((function(e){for(var i=0;i<t.length;i+=2){if(i+1>=t.length)throw new Error("Missing value for key: "+t[i])
e.set(t[i],t[i+1])}}))}
He.prototype.toString=function(){return this.__toString("Map {","}")}
He.prototype.get=function(e,t){return this._root?this._root.get(0,void 0,e,t):t}
He.prototype.set=function(e,t){return ot(this,e,t)}
He.prototype.setIn=function(e,t){return this.updateIn(e,v,(function(){return t}))}
He.prototype.remove=function(e){return ot(this,e,v)}
He.prototype.deleteIn=function(e){return this.updateIn(e,(function(){return v}))}
He.prototype.update=function(e,t,i){return 1===arguments.length?e(this):this.updateIn([e],t,i)}
He.prototype.updateIn=function(e,t,i){if(!i){i=t
t=void 0}var n=ft(this,ki(e),t,i)
return n===v?void 0:n}
He.prototype.clear=function(){if(0===this.size)return this
if(this.__ownerID){this.size=0
this._root=null
this.__hash=void 0
this.__altered=true
return this}return rt()}
He.prototype.merge=function(){return lt(this,void 0,arguments)}
He.prototype.mergeWith=function(t){var i=e.call(arguments,1)
return lt(this,t,i)}
He.prototype.mergeIn=function(t){var i=e.call(arguments,1)
return this.updateIn(t,rt(),(function(e){return"function"===typeof e.merge?e.merge.apply(e,i):i[i.length-1]}))}
He.prototype.mergeDeep=function(){return lt(this,pt,arguments)}
He.prototype.mergeDeepWith=function(t){var i=e.call(arguments,1)
return lt(this,mt(t),i)}
He.prototype.mergeDeepIn=function(t){var i=e.call(arguments,1)
return this.updateIn(t,rt(),(function(e){return"function"===typeof e.mergeDeep?e.mergeDeep.apply(e,i):i[i.length-1]}))}
He.prototype.sort=function(e){return Gt(di(this,e))}
He.prototype.sortBy=function(e,t){return Gt(di(this,t,e))}
He.prototype.withMutations=function(e){var t=this.asMutable()
e(t)
return t.wasAltered()?t.__ensureOwner(this.__ownerID):this}
He.prototype.asMutable=function(){return this.__ownerID?this:this.__ensureOwner(new S)}
He.prototype.asImmutable=function(){return this.__ensureOwner()}
He.prototype.wasAltered=function(){return this.__altered}
He.prototype.__iterator=function(e,t){return new Ze(this,e,t)}
He.prototype.__iterate=function(e,t){var i=this
var n=0
this._root&&this._root.iterate((function(t){n++
return e(t[1],t[0],i)}),t)
return n}
He.prototype.__ensureOwner=function(e){if(e===this.__ownerID)return this
if(!e){this.__ownerID=e
this.__altered=false
return this}return it(this.size,this._root,e,this.__hash)}
function Ve(e){return!!(e&&e[We])}He.isMap=Ve
...
St.prototype.get=function(e,t){e=x(this,e)
if(e>=0&&e<this.size){e+=this._origin
var i=Tt(this,e)
return i&&i.array[e&b]}return t}
St.prototype.set=function(e,t){return Mt(this,e,t)}
...
function jt(e){return!!(e&&e[Ct])}St.isList=jt
var Ct="@@__IMMUTABLE_LIST__@@"
var xt=St.prototype
xt[Ct]=true
xt[g]=xt.remove
xt.setIn=Ke.setIn
xt.deleteIn=xt.removeIn=Ke.removeIn
xt.update=Ke.update
xt.updateIn=Ke.updateIn
xt.mergeIn=Ke.mergeIn
xt.mergeDeepIn=Ke.mergeDeepIn
xt.withMutations=Ke.withMutations
xt.asMutable=Ke.asMutable
xt.asImmutable=Ke.asImmutable
xt.wasAltered=Ke.wasAltered
...
var i=t?--d:_++
s=a(c&&c[i],r-f,o+(i<<r))}while(true)}}}function Dt(e,t,i,n,r,o,a){var s=Object.create(xt)
s.size=t-e
s._origin=e
s._capacity=t
s._level=i
...
s.__altered=false
return s}var Nt
function Pt(){return Nt||(Nt=Dt(0,0,f))}function Mt(e,t,i){t=x(e,t)
if(t!==t)return e
...
return gt(e,t,n)}function Rt(e){return e<h?0:e-1>>>f<<f}t(Gt,He)
function Gt(e){return null===e||void 0===e?Vt():Ft(e)?e:Vt().withMutations((function(t){var i=n(e)
Ue(i.size)
...
function Ft(e){return Ve(e)&&d(e)}Gt.isOrderedMap=Ft
Gt.prototype[m]=true
...
r.__hash=n
return r}var Ht
function Vt(){return Ht||(Ht=Ut(rt(),Pt()))}function Wt(e,t,i){var n=e._map
var r=e._list
var o=n.get(t)
var a=void 0!==o
var s
...
var i=this._iter.__iterator(M,t)
var n=t?fi(this):0
...
Jt.prototype.__iterator=function(e,t){var i=this._iter.__iterator(M,t)
var n=0
...
Qt.prototype.__iterator=function(e,t){var i=this._iter.__iterator(M,t)
return new L((function(){var t=i.next()
...
Yt.prototype.__iterator=function(e,t){var i=this._iter.__iterator(M,t)
...
e.value[0]=e.value[1]
e.value[1]=t}return e}))}return e.__iterator(t===M?P:M,i)}
...
!n&&ie(e)&&c>=0&&(_.get=function(t,i){t=x(this,t)
...
if(++s>c)return G()
var e=r.next()
return n||t===M?e:R(t,s-1,t===P?void 0:e.value[1],e)}))}
...
do{e=s.next()
if(e.done)return n||r===M?e:R(r,_++,r===P?void 0:e.value[1],e)
var u=e.value
o=u[0]
d=u[1]
...
return o}
i.__iteratorUncached=function(i,n){var r=e.__iterator(M,n)
var o=0
var a
...
r.__iterate=function(e,t){var i=this.__iterator(M,t)
var n
var r=0
while(!(n=i.next()).done)if(false===e(n.value,r++,this))break
return r}
r.__iteratorUncached=function(e,r){var o=n.map((function(e){return e=i(e),H(r?e.reverse():e)}))
var a=0
var s=false
...
return C(e)}function hi(e){return s(e)?n:c(e)?r:o}function bi(e){return Object.create((s(e)?J:c(e)?Q:Y).prototype)}function vi(){if(this._iter.cacheResult){this._iter.cacheResult()
this.size=this._iter.size
return this}return K.prototype.cacheResult.call(this)}function yi(e,t){return e>t?1:e<t?-1:0}function ki(e){var t=H(e)
if(!t){if(!W(e))throw new TypeError("Expected iterable or array-like: "+e)
t=H(i(e))}return t}t(wi,ze)
...
r._name=t
r._keys=a
r._defaultValues=e}this._map=He(o)}
...
n._map=t
n.__ownerID=i
return n}function ji(e){return e._name||e.constructor.name||"Record"}function Ci(e,t){try{t.forEach(xi.bind(void 0,e))}catch(e){}}function xi(e,t){Object.defineProperty(e,t,{get:function(){return this.get(t)},set:function(e){ve(this.__ownerID,"Cannot set on an immutable record.")
...
e._map=t
return e}return t===e._map?e:0===t.size?e.__empty():e.__make(t)}function Pi(e,t){var i=Object.create(Di)
i.size=e?e.size:0
i._map=e
i.__ownerID=t
return i}var Mi
function qi(){return Mi||(Mi=Pi(rt()))}t(Bi,Oi)
...
i.__ownerID=t
return i}var Ri
function Gi(){return Ri||(Ri=Li(Vt()))}t(Fi,Se)
...
function Ui(e){return!!(e&&e[Hi])}Fi.isStack=Ui
var Hi="@@__IMMUTABLE_STACK__@@"
var Vi=Fi.prototype
Vi[Hi]=true
Vi.withMutations=Ke.withMutations
Vi.asMutable=Ke.asMutable
Vi.asImmutable=Ke.asImmutable
Vi.wasAltered=Ke.wasAltered
function Wi(e,t,i,n){var r=Object.create(Vi)
r.size=e
r._head=t
r.__ownerID=i
r.__hash=n
...
return t},keys:function(){return this.__iterator(P)},map:function(e,t){return mi(this,Xt(this,e,t))},reduce:function(e,t,i){Ue(this.size)
var n
var r
...
return n.reduce.apply(n,arguments)},reverse:function(){return mi(this,Zt(this,true))},slice:function(e,t){return mi(this,ni(this,e,t,true))},some:function(e,t){return!this.every(en(e),t)},sort:function(e){return mi(this,di(this,e))},values:function(){return this.__iterator(M)},butLast:function(){return this.slice(0,-1)},isEmpty:function(){return void 0!==this.size?0===this.size:!this.some((function(){return true}))},count:function(e,t){return C(e?this.toSeq().filter(e,t):this)},countBy:function(e,t){return ti(this,e,t)},equals:function(e){return fe(this,e)},entrySeq:function(){var e=this
...
return i?i[0]:-1},first:function(){return this.get(0)},flatten:function(e){return mi(this,si(this,e,false))},get:function(e,t){e=x(this,e)
return e<0||Infinity===this.size||void 0!==this.size&&e>this.size?t:this.find((function(t,i){return i===e}),void 0,t)},has:function(e){e=x(this,e)
...
return sn(r,n)}function sn(e,t){t=Ce(t,3432918353)
...
t=xe(t^t>>>16)
return t}function cn(e,t){return e^t+2654435769+(e<<6)+(e>>2)|0}var _n={Iterable:i,Seq:K,Collection:we,Map:He,OrderedMap:Gt,List:St,Stack:Fi,Set:Oi,OrderedSet:Bi,Record:wi,Range:ye,Repeat:he,is:ge,fromJS:ue}
...
var N=(C=Object(z["a"])(),x=Object(v["i"])(j,D),C(O=x(O=(A=E=function(e){Object(_["a"])(t,e)
function t(){var e
var i
Object(o["a"])(this,t)
...
var C=function(e){Object(s["a"])(t,e)
...
var F=(B=Object(b["a"])("7.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),T=Object(P["i"])(q,G),B(I=T(I=(R=L=function(e){Object(s["a"])(t,e)
function t(e){var i
Object(n["a"])(this,t)
...
var H=i("JPcv")
var V=i("x1Tw")
const W=e=>V["a"].get("/api/v1/accounts/".concat(e,"/outcome_proficiency"))
const K=(e,t)=>V["a"].post("/api/v1/accounts/".concat(e,"/outcome_proficiency"),t)
var J=i("HbFp")
var Q=i("f6Li")
const Y="EF4437"
function $(e){if("#"===e[0])return e.substring(1)
return e}var X=Object(r["a"])(x["a"],{},void 0,Object(r["a"])(Q["a"],{url:"/images/trophy.svg"}))
...
else{g.a.flashError(C.t("An error occurred while loading account proficiency ratings"))
this.setState({loading:false})}}).catch(e=>{e.response&&404!==e.response.status&&g.a.flashError(C.t("An error occurred while loading account proficiency ratings: %{m}",{m:e.response.statusText}))
this.setState({billboard:true,loading:false})})}
this.configToState=e=>{const t=Object(H["List"])(e.ratings.map(e=>this.createRating(e.description,e.points,e.color)))
const i=e.ratings.findIndex(e=>e.mastery)
this.setState({loading:false,masteryIndex:i,rows:Object(H["fromJS"])(t)})}
...
return Object(H["fromJS"])({description:e,points:t,key:G()(),color:i,focusField:n})}
this.addRow=()=>{let e=0
...
g.a.screenReaderFlashMessage(C.t("Added new proficiency rating"))}
...
g.a.screenReaderFlashMessage(C.t("Proficiency Rating deleted"))})
...
this.handleSubmit=()=>{this.checkForErrors()||K(this.props.accountId,this.stateToConfig()).then(e=>{200===e.status?g.a.flashMessage(C.t("Account proficiency ratings saved")):g.a.flashError(C.t("An error occurred while saving account proficiency ratings"))})}
this.checkForErrors=()=>{let e=null
let t=true
const i=this.state.rows.map(i=>{let n=i
if(this.invalidDescription(i.get("description"))){n=n.set("descriptionError",C.t("Missing required description"))
if(t){n=n.set("focusField","description")
t=false}}if(this.invalidPoints(i.get("points"))){e=null
n=n.set("pointsError",C.t("Invalid points"))
if(t){n=n.set("focusField","points")
t=false}}else if(i.get("points")<0){n=n.set("pointsError",C.t("Negative points"))
if(t){n=n.set("focusField","points")
t=false}}else{const r=i.get("points")
if(null!==e&&e<=r){n=n.set("pointsError",C.t("Points must be less than previous rating"))
if(t){n=n.set("focusField","points")
...
this.state={loading:true,masteryIndex:1,rows:Object(H["List"])([this.createRating("Exceeds Mastery",4,"127A1B"),this.createRating("Mastery",3,"00AC18"),this.createRating("Near Mastery",2,"FAB901"),this.createRating("Below Mastery",1,"FD5D10"),this.createRating("Well Below Mastery",0,"EE0612")])}}componentDidMount(){this.fetchRatings()}componentDidUpdate(){this.fieldWithFocus()&&this.setState({rows:this.state.rows.map(e=>e.delete("focusField"))})}renderSpinner(){return Object(r["a"])("div",{style:{textAlign:"center"}},void 0,Object(r["a"])(E["a"],{renderTitle:C.t("Loading"),size:"large",margin:"0 0 0 medium"}))}renderBillboard(){const e={width:"10rem",margin:"0 auto"}
const t={textAlign:"center"}
return Object(r["a"])("div",{style:t},void 0,a.a.createElement(z["a"],{headingAs:"h2",headingLevel:"h2",ref:e=>{this.triggerRoot=e},hero:Object(r["a"])("div",{style:e},void 0,X),heading:C.t("Customize Learning Mastery Ratings"),message:C.t("\n            Set up how your Proficiency Ratings appear inside of Learning Mastery Gradebook.\n            Adjust number of ratings, mastery level, points, and colors.\n          ").trim()}),Object(r["a"])(S["a"],{variant:"primary",onClick:this.removeBillboard},void 0,C.t("Get Started")))}renderTable(){const e=this.state.masteryIndex
return Object(r["a"])("div",{},void 0,Object(r["a"])(A["a"],{caption:Object(r["a"])(O["a"],{},void 0,C.t("Proficiency ratings"))},void 0,Object(r["a"])("thead",{},void 0,Object(r["a"])("tr",{},void 0,Object(r["a"])("th",{className:"masteryCol",scope:"col"},void 0,C.t("Mastery")),Object(r["a"])("th",{scope:"col"},void 0,C.t("Proficiency Rating")),Object(r["a"])("th",{className:"pointsCol",scope:"col"},void 0,C.t("Points")),Object(r["a"])("th",{className:"colorCol",scope:"col"},void 0,C.t("Color")))),Object(r["a"])("tbody",{},void 0,this.state.rows.map((t,i)=>Object(r["a"])(L,{color:t.get("color"),description:t.get("description"),descriptionError:t.get("descriptionError"),disableDelete:1===this.state.rows.size,focusField:t.get("focusField")||(0===i?"mastery":null),points:t.get("points").toString(),pointsError:t.get("pointsError"),mastery:i===e,onColorChange:this.handleColorChange(i),onDelete:this.handleDelete(i),onDescriptionChange:this.handleDescriptionChange(i),onMasteryChange:this.handleMasteryChange(i),onPointsChange:this.handlePointsChange(i)},t.get("key"))),Object(r["a"])("tr",{},void 0,Object(r["a"])("td",{colSpan:"4",style:{textAlign:"center"}},void 0,Object(r["a"])(S["a"],{onClick:this.addRow,icon:Z,variant:"circle-primary"},void 0,Object(r["a"])(O["a"],{},void 0,C.t("Add proficiency rating"))))))),Object(r["a"])("div",{className:"save"},void 0,Object(r["a"])(S["a"],{variant:"primary",onClick:this.handleSubmit},void 0,C.t("Save Learning Mastery"))))}render(){const e=this.state,t=e.billboard,i=e.loading
...
var C=i("FIFq")
var x=function(e,t){for(var i in t)O.call(t,i)&&(e[i]=t[i])
function n(){this.constructor=e}n.prototype=t.prototype
e.prototype=new n
e.__super__=t.prototype
...
var N=i.n(D)
i("BYL3")
var P=function(e,t){return function(){return e.apply(t,arguments)}},M=function(e,t){for(var i in t)q.call(t,i)&&(e[i]=t[i])
function n(){this.constructor=e}n.prototype=t.prototype
e.prototype=new n
e.__super__=t.prototype
return e},q={}.hasOwnProperty
t["a"]=function(e){M(t,e)
function t(){this.updateListOfRecipients=P(this.updateListOfRecipients,this)
this.getFormData=P(this.getFormData,this)
this._findRecipientGroupByName=P(this._findRecipientGroupByName,this)
this.validateBeforeSave=P(this.validateBeforeSave,this)
this.toJSON=P(this.toJSON,this)
...
var D=(j=Object(f["a"])("7.0.0",{label:"renderLabel",disabled:"interaction",readOnly:"interaction",required:"isRequired",inline:"display"}),C=Object(z["i"])(S,A),j(x=C(x=(E=O=function(e){Object(c["a"])(t,e)
function t(e){var i
Object(r["a"])(this,t)
i=Object(a["a"])(this,Object(s["a"])(t).call(this))
...
var C=(y=Object(b["a"])(),k=Object(f["i"])(v,j),y(w=k(w=(S=z=function(e){Object(c["a"])(t,e)
function t(){Object(r["a"])(this,t)
return Object(a["a"])(this,Object(s["a"])(t).apply(this,arguments))}Object(o["a"])(t,[{key:"render",value:function(){var e
...
var O=(z=Object(b["i"])(w,x),z(S=(C=j=function(e){Object(_["a"])(t,e)
function t(){var e
var i
Object(o["a"])(this,t)
for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
return u.a.createElement("span",{className:x.heading},u.a.createElement(f["a"],{level:t,as:i,color:"primary",__dangerouslyIgnoreExperimentalWarnings:true},n))}},{key:"renderHero",value:function(){return this.heroIsFunction?this.props.hero(this.SVGIconSize):this.props.hero}},{key:"renderContent",value:function(){var e=this.props,t=e.heading,i=e.message,n=e.hero
return u.a.createElement("span",{className:x.content},n&&u.a.createElement("span",{className:x.hero},this.renderHero()),t&&this.renderHeading(),i&&u.a.createElement("span",{className:x.message},Object(v["a"])(i)))}},{key:"render",value:function(){var e
var i=this.props,o=i.href,a=i.disabled,s=i.readOnly,c=i.onClick,_=i.size,d=i.margin,l=i.elementRef
var p=(e={},Object(r["a"])(e,x.root,true),Object(r["a"])(e,x[_],true),Object(r["a"])(e,x.clickable,o||c),Object(r["a"])(e,x.disabled,a),e)
...
i("DfGn")
var S=z.a.default
var j=S.template,C=S.templates=S.templates||{}
var x="outcomes/outcomeCalculationMethodForm"
C[x]=j((function(e,t,i,n,r){this.compilerInfo=[4,">= 1.0.0"]
i=this.merge(i,e.helpers)
n=this.merge(n,e.partials)
r=r||{}
...
return c}))
var M=N[P]
Object(s["a"])(JSON.parse('{"ar":{"outcomes":{"criterion_header":{"insert_criterion_rating":"إدخال تصنيف المعيار","insert_rating":"إدخال"}}},"cy":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Mewnosod sgôr maen prawf","insert_rating":"Mewnosod"}}},"da":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Indfør kriteriebedømmelse","insert_rating":"Indsæt"}}},"de":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Kriterienbewertung einfügen","insert_rating":"Einfügen"}}},"el":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Εισαγωγή αξιολόγησης κριτηρίου","insert_rating":"Εισαγωγή"}}},"en-AU":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insert criterion rating","insert_rating":"Insert"}}},"en-AU-x-unimelb":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insert criterion rating","insert_rating":"Insert"}}},"en-CA":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insert criterion rating","insert_rating":"Insert"}}},"en-GB":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insert criterion rating","insert_rating":"Insert"}}},"en-GB-x-ukhe":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insert criterion rating","insert_rating":"Insert"}}},"es":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Introducir evaluación de criterios","insert_rating":"Introducir"}}},"fa":{"outcomes":{"criterion_header":{"insert_criterion_rating":"درج رتبه بندی معیار","insert_rating":"درج"}}},"fi":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Lisää kriteerien luokitus","insert_rating":"Aseta"}}},"fr":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insérer la notation du critère","insert_rating":"Insérer"}}},"fr-CA":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Insérer la notation du critère","insert_rating":"Insérer"}}},"he":{"outcomes":{"criterion_header":{"insert_criterion_rating":"הוספת קריטריון דרוג","insert_rating":"הוספה"}}},"ht":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Ensere kritè notasyon","insert_rating":"Ensere"}}},"hu":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Kritériumértékelés beszúrása","insert_rating":"Beszúrás"}}},"hy":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Տեղադրել չափանիշի գնահատականը","insert_rating":"Տեղադրել"}}},"is":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Setja inn viðmiðunarmat","insert_rating":"Setja inn"}}},"it":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Inserisci valutazione basata su criterio","insert_rating":"Inserisci"}}},"ja":{"outcomes":{"criterion_header":{"insert_criterion_rating":"基準の評価を挿入する","insert_rating":"挿入"}}},"ko":{"outcomes":{"criterion_header":{"insert_criterion_rating":"기준 등급 삽입","insert_rating":"삽입"}}},"mi":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Whakauru whakatauranga paearu","insert_rating":"Whakauru"}}},"nb":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Sett inn kriterievurdering","insert_rating":"Sett inn"}}},"nl":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Standaard beoordeling invoegen","insert_rating":"Invoegen"}}},"nn":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Set inn kriterievurdering","insert_rating":"Set inn"}}},"pl":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Wstaw klasyfikację dla kryterium","insert_rating":"Wstaw"}}},"pt":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Inserir classificação de critério","insert_rating":"Inserir"}}},"pt-BR":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Inserir classificação de critério","insert_rating":"Inserir"}}},"ru":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Вставить рейтинг критерия","insert_rating":"Вставить"}}},"sv":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Sätt in värderingskriterium","insert_rating":"Sätt in"}}},"tr":{"outcomes":{"criterion_header":{"insert_criterion_rating":"Kriter oranı ekle","insert_rating":"Ekle"}}},"zh-Hans":{"outcomes":{"criterion_header":{"insert_criterion_rating":"插入标准等级","insert_rating":"插入"}}},"zh-Hant":{"outcomes":{"criterion_header":{"insert_criterion_rating":"插入標準評級","insert_rating":"插入"}}}}'))
...
const t=o()(H({description:"",points:"",_index:99}))
...
this.$el.html(Ce(f.a.extend(e,{canManage:t})))}this.$("input:first").focus()
return this}}var Pe=i("VAoc")
var Me=i("Cf7h")
var qe=function(){function e(){}e.prototype.find=function(){var e,t
e=null
t=Object(Me["a"])(ENV.context_asset_string||"")
e=new l["a"]
...
setTimeout(()=>n.tree.focusOnOpen(),200)}createTree(){var e=new Pe["a"]({rootModelsFinder:new qe,focusStyleClass:"MoveDialog__folderItem--focused",selectedStyleClass:"MoveDialog__folderItem--selected",onlyShowSubtrees:true,onClick(){Pe["a"].prototype.setActiveTree(this,e)}}).render()
...
var D=(S=Object(w["a"])(),j=Object(v["a"])(),C=Object(h["i"])(z,A),S(x=j(x=C(x=(E=O=function(e){Object(_["a"])(t,e)
...
var B=(C=Object(k["a"])(),C(x=(E=O=function(e){Object(c["a"])(t,e)
function t(){Object(o["a"])(this,t)
return Object(a["a"])(this,Object(s["a"])(t).apply(this,arguments))}return t}(v["a"]),O.displayName="PopoverContent",E))||x)
var T=(A=Object(k["a"])(),D=Object(g["a"])(),A(N=D(N=(M=P=function(e){Object(c["a"])(t,e)
function t(){var e
var i
Object(o["a"])(this,t)
