(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[94],{"7LJr":function(e,t,i){"use strict"
var o=i("ouhR")
var s=i.n(o)
...
var m=i("VTJ5")
var c=i("5JRF")
function p(e){return Object(o["a"])(r["a"],{startAt:"medium",vAlign:"middle",rowSpacing:"none",colSpacing:"none"},void 0,Object(o["a"])(r["a"].Row,{vAlign:"middle",rowSpacing:"none"},void 0,Object(o["a"])(r["a"].Col,{hAlign:"center",textAlign:"center"},void 0,Object(o["a"])(m["a"],{renderTitle:l["a"].t("Duplicating Module")}))),Object(o["a"])(r["a"].Row,{},void 0,Object(o["a"])(r["a"].Col,{hAlign:"center",textAlign:"center"},void 0,Object(o["a"])(c["a"],{},void 0,l["a"].t("Duplicating Module...")))))}var h=i("i8i4")
var f=i.n(h)
var b=i("bmrg")
var g=i("FIFq")
var y=i.n(g)
...
i("7LJr")
var O=function(e,t){return function(){return e.apply(t,arguments)}},R=function(e,t){for(var i in t)F.call(t,i)&&(e[i]=t[i])
function o(){this.constructor=e}o.prototype=t.prototype
e.prototype=new o
e.__super__=t.prototype
return e},F={}.hasOwnProperty
var N=function(e){R(t,e)
...
i("DfGn")
var K=V.a.default
var W=K.template,B=K.templates=K.templates||{}
var H="modules/RelockModulesDialog"
B[H]=W((function(e,t,i,o,s){this.compilerInfo=[4,">= 1.0.0"]
...
return this.dialog.disableWhileLoading(S.a.ajaxJSON(e,"PUT",{},()=>this.close()))}}J.prototype.template=G
var Y=i("goGJ")
var $=V.a.default
...
i=this.merge(i,e.helpers)
s=s||{}
var _,n,a="",l="function",d=this.escapeExpression,u=this
function r(e,t){var o,s,_=""
_+='href="'
...
_=i["if"].call(t,t&&t.link_href,{hash:{},inverse:u.noop,fn:u.program(1,r,s),data:s});(_||0===_)&&(a+=_)
a+="\n  >"
...
_=i.each.call(t,t&&t.due_dates,{hash:{},inverse:u.noop,fn:u.program(3,m,s),data:s});(_||0===_)&&(a+=_)
a+="\n    "
_=i["if"].call(t,t&&t.more_message,{hash:{},inverse:u.noop,fn:u.program(5,c,s),data:s});(_||0===_)&&(a+=_)
a+="\n  </dl>\n</div>"
return a}))
...
S()(".context_module").each((function(){he(S()(this))}))},updateProgressions(e){if(!ENV.IS_STUDENT){e&&e()
...
fe(i,"icon-check",E.t("Completed"))}else if("completed"==s)e.hasClass("progression_requirement")&&fe(i,"no-icon",E.t("Not completed"))
else if(null!=e.data("past_due"))fe(i,"icon-minimize",E.t("This assignment is overdue"))
else{let t=null
for(const e in l)l[e].id==n&&(t=l[e])
t?null!=t.score?fe(i,"icon-minimize",E.t("You scored a %{score}.",{score:t.score})+" "+be(e)+"."):fe(i,"icon-info",E.t("Your submission has not been graded yet")):e.hasClass("progression_requirement")&&fe(i,"icon-mark-as-read",be(e))}}))
...
const e=S()("<div />",{text:ve(o),class:"prerequisites_message"})
i.append(e)}}
const ye=function(e,t){S()("div.context_module .prerequisite_criterion .id").each((function(i,o){const s=S()(o)
const _=s.text()
...
i.find(".prerequisites_message").text(ve(o))}}))}
var ve=function(e){return E.t("Prerequisites: %{list}",{list:e})}
const ke=function(e,t){const i=e.find(".requirements_message")
...
var xe=Object(o["a"])(p,{})
modules.initModuleManagement=function(){new N({el:S()("#content"),modules:modules})
const e=new J
...
ge(i,t.context_module.prerequisites)
ye(t.context_module.id,t.context_module.name)
0===t.context_module.completion_requirements.length?i.find(".requirements_message").empty():ke(i,t.context_module.requirement_count)
...
me["a"].get(_).then(e=>{const o=S()(e.data)
...
S()(".context_module").find(".expand_module_link,.collapse_module_link").bind("click keyclick",Me)
modules.initModuleManagement()}).catch(Object(ce["b"])(E.t("Error rendering duplicated module")))}
me["a"].post(t,{}).then(_).catch(Object(ce["b"])(E.t("Error duplicating module")))}))
...
const n=!re()(ENV,"MASTER_COURSE_SETTINGS.IS_MASTER_COURSE")&&!!re()(_,"content")
s.attr("disabled",n)
...
return}if(C["a"]&&C["a"].selectContentDialog){const e=S()(this).parents(".context_module").find(".header").attr("id")
...
me["a"].post(i).then(e=>{let i=e.data
...
t.find(".context_module_items.ui-sortable").sortable("enable").sortable("refresh")}).catch(Object(ce["b"])("Error duplicating item"))}))
...
const _=u.a.createElement(a["a"],s)
f.a.render(_,e[0])
...
const r=function(e){const t=e.publish,i=e.unpublish
...
var m=function(e,t){const i=qe(e)
null===i?d(e):r(e)
_[i]||(_[i]=[])
...
s.render()})}
const we={page:"wiki_page",discussion:"discussion_topic",external_tool:"context_external_tool",sub_header:"context_module_sub_header"}
function qe(e){if(null===e)return null
...
return i+"_"+o}return null}var Me=function(e){e.preventDefault()
const t=null
...
"1"!=i&&s||_()}
function ze(e){return"none"===e.style.display||e.parentElement.classList.contains("collapsed_module")}modules.updateAssignmentData(()=>{modules.updateProgressions((function(){if(window.location.hash&&!window.location.hash.startsWith("#!"))try{pe(S()(window.location.hash))}catch(e){}else{var e
const t=null===(e=document.querySelector(".context_module"))||void 0===e?void 0:e.querySelector(".content")
if(!t||ze(t)){const e=[...document.querySelectorAll(".context_module .content")].find(e=>!ze(e))
e&&pe(S()(e).parents(".context_module"))}}}))})
S()(document).ready((function(){S()(".context_module").each((function(){he(S()(this))}))
...
t.preventDefault()})
_.keycodes("n",e=>{S()(".add_module_link:visible:first").click()
e.preventDefault()})
...
modules.loadMasterCourseData()}S()(".context_module").find(".expand_module_link,.collapse_module_link").bind("click keyclick",Me)
...
for(const e in n)S()("#context_module_"+n[e]).addClass("collapsed_module")
const a=S()("#context_modules .context_module")
if(!a.length){S()("#no_context_modules_message").show()
S()("#context_modules_sortable_container").addClass("item-group-container--is-empty")}a.each((function(){modules.updateProgressionState(S()(this))}))
function l(e,t,i,s){const _=()=>{var e
l(null)
s.focus();(null===le["ltiState"]||void 0===le["ltiState"]?void 0:null===(e=le["ltiState"].tray)||void 0===e?void 0:e.refreshOnClose)&&window.location.reload()}
f.a.render(Object(o["a"])(ae["a"],{tool:e,placement:"module_index_menu",acceptedResourceTypes:["assignment","audio","discussion_topic","document","image","module","quiz","page","video"],targetResourceType:"module",allowItemSelection:i,selectableItems:t,onDismiss:_,open:null!==e}),S()("#external-tool-mount-point")[0])}function d(e){null!=e&&e.preventDefault()
const t=e.target.dataset.toolLaunchType
const i=(ENV.MODULE_TRAY_TOOLS[t]||[]).find(t=>t.id===e.target.dataset.toolId)
const o=[]
if("module_index_menu"==t)S()("#context_modules .context_module").each((function(){o.push({id:S()(this).attr("id").substring("context_module_".length),name:S()(this).find(".name").attr("title")})}))
else if("module_group_menu"==t){const t=S()(e.target).parents(".context_module")
o.push({id:t.attr("id").substring("context_module_".length),name:t.find(".name").attr("title")})}l(i,o,"module_index_menu"==t,S()(".al-trigger")[0])}S()(".menu_tray_tool_link").click(d)
Object(de["a"])()}))
...
var a=i("GLiE")
var l=i.n(a)
var d,u=function(e,t){return function(){return e.apply(t,arguments)}},r=function(e,t){for(var i in t)m.call(t,i)&&(e[i]=t[i])
function o(){this.constructor=e}o.prototype=t.prototype
e.prototype=new o
e.__super__=t.prototype
...
t.prototype._setStateAfterFetch=function(e,t){var i,o,s,_,n,a,l,d,u,r,m,c,h,f
...
h=null!=(u=this.urls.first)?u:this.urls.next
if(null!=h){n=parseInt(h.match(this.perPageRegex)[1],10);(null!=(i=null!=this.options?this.options:this.options={}).params?i.params:i.params={}).per_page=n}this.urls.last&&(s=this.urls.last.match(this.pageRegex))&&(this.totalPages=parseInt(s[1],10));(null!=(r=this.urls)?r.next:void 0)||(this.loadedAll=true)
...
//# sourceMappingURL=94-c-425efbcbeb.js.map